...
public class MotorConfig {
     ...
     public MotorConfig(int canId, String canBus, int currentLimit, Boolean inversion, PIDConfig pid, Mode mode) { this(canId, canBus, currentLimit, inversion, pid, mode, new ConversionConfig());}
